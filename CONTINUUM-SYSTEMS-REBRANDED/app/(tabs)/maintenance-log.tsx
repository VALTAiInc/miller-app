  ...
  const [entries, setEntries] = useState<LogEntry[]>([
    {
      ...
      notes: "Adjusted arc control for cleaner toe on 1/4\" steel. Excellent puddle control.",
      ts: Date.now() - 60 * 60 * 1000,
    },
    {
      id: uid(),
      title: "Versa-Pulse on 16ga sheet metal",
      notes: "Low heat setting worked perfectly. Minimal warpage, fast travel speed.",
