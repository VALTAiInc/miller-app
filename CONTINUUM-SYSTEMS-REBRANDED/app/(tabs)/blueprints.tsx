...
const ACCENT = Brand.millerBlue ?? "#006bae";
...
export default function BlueprintsScreen() {
  ...
  return (
    <View style={styles.root}>
      ...
      >
        <Text style={styles.headerTitle}>Manual & Reference</Text>
        ...
        <View style={styles.card}>
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.rowTitle}>Parameter Charts</Text>
              <Text style={styles.rowSub}>
                Voltage, amperage, wire feed speed tables
              </Text>
            </View>
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.rowTitle}>Troubleshooting Guides</Text>
              <Text style={styles.rowSub}>
                Diagnostic flowcharts and common issues
              </Text>
            </View>
        ...
        <Text style={[styles.sectionTitle, { marginTop: 22 }]}>Documentation</Text>
        ...
        <View style={styles.pinned}>
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.pinnedTitle}>Miller Operations Manual</Text>
              <Text style={styles.pinnedSub}>Full Continuum system documentation</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  iconCircle: {
    ...
    height: 38,
    borderRadius: 19,
    backgroundColor: "rgba(0,107,174,0.12)",
    alignItems: "center",
    justifyContent: "center",
    borderWidth: 1,
    borderColor: "rgba(0,107,174,0.22)",
  },
  rowTitle: {
    fontSize: 18,
    fontWeight: "800" as const,
  ...
  thumbLine: {
    ...
    height: 3,
    borderRadius: 2,
    backgroundColor: "rgba(0,107,174,0.45)",
  },
  pinnedTitle: {
    fontSize: 18,
    fontWeight: "800" as const,
