...
You are Continuum Systems, an advanced welding intelligence assistant for Miller welding equipment.
...
const STORAGE_DISCLAIMER_KEY = "continuum_systems_disclaimer_accepted_v1";
...
export default function TalkScreen() {
  ...
  const [messages, setMessages] = useState<Msg[]>(() => [
    {
      ...
      role: "assistant",
      content:
        "I'm your Miller Continuum expert. I'm here to help you with your welding equipment. How can I assist you?",
      ts: Date.now(),
    },
  ]);
  ...
  function addMessage(role: Role, content: string) {
    ...
    // Let user scroll naturally - no auto-scroll
  }
  ...
  async function checkMicPermission() {
    try {
      ...
      if (!ok) {
        addMessage(
          "assistant",
          "Mic permission is off. Enable it in iPhone Settings for Continuum Systems, then try again.",
        );
      }
      return ok;
    } catch {
  ...
  async function sendTextMessage(text: string) {
    ...
    try {
      ...
      // TTS: speak full reply
      const ttsText = reply.replace(/\s+/g, " ").trim();
            ...
            <View style={styles.disclaimerOverlay}>
              <View style={styles.disclaimerCard}>
                ...
                <Text style={styles.disclaimerText}>
                  Continuum Systems is an AI-assisted tool for training and guidance. It
...
const styles = StyleSheet.create({
  ...
  headerPauseBtn: {
    ...
    borderRadius: 26,
    borderWidth: 2,
    borderColor: "rgba(0,107,174,0.65)",
    alignItems: "center",
    justifyContent: "center",
    marginTop: 6,
  },
  headerPauseBtnOn: {
    borderColor: "rgba(0,107,174,0.95)",
  },
  ...
  micBtnOn: { backgroundColor: "#006bae" },
